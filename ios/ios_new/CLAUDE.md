...
- **Entitlements File**: `Config/ACLRehabTracker.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/ACLRehabTracker.entitlements`:
